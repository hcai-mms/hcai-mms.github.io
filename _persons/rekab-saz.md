...
first_name: Navid
last_name: Rekab-saz
title: "Navid Rekab-saz"
key: rekab-saz # this should be your lastname in lower case; the key is important for publications or other listings that need to be linked to your profile. it needs to be unique (should there be someone else with the same lastname, please contact the admin)
...
website: https://navid-rekabsaz.github.io/
