...
last_name: Hannan
title: "Abdul Hannan"
key: hannan # this should be your lastname in lower case; the key is important for publications or other listings that need to be linked to your profile. it needs to be unique (should there be someone else with the same lastname, please contact the admin)
...
image: /assets/images/team_colored/x.png # insert the relative link to your profile image
