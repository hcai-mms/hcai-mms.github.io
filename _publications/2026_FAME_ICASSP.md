...
title: "Linking Faces and Voices Across Languages: Insights from the FAME 2026 Challenge" # title of your publication 
...
type: paper
abstract: "Over half of the world’s population is bilingual and people often communicate under multilingual scenarios. The FaceVoice Association in Multilingual Environments (FAME) 2026 Challenge, held at ICASSP 2026, focuses on developing methods for face-voice association that are effective when the language at test-time is different than the training one. This report provides a brief summary of the challenge."
####
